...
namespace HR.LeaveManagement.BlazorUI.Services
{
    public class LeaveTypeService : BaseHttpService, ILeaveTypeService
    {
        ...
        public async Task<Response<Guid>> CreateLeaveTypes(LeaveTypeVM leaveType)
        {
            try
            {
        ...
        public async Task<LeaveTypeVM> GetLeaveTypesDetails(int id)
        {
            var leaveType = await _client.LeaveTypesGETAsync(id);
            return _mapper.Map<LeaveTypeVM>(leaveType);
        }

        public async Task<Response<Guid>> UpdateLeaveTypes(int id, LeaveTypeVM leaveType)
        {
            try
            {
